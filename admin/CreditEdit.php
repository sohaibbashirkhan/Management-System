...
include_once("DatabaseConn.php");
     $id = $_GET['id'];
     $row = mysqli_fetch_assoc(mysqli_query($conn,"select * from credit where id='$id'"));
  ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <title>Dashboard - Credit Edit</title>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Edit Credit</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Edit Credit Dashboard</li>
                </ol>
                        <h1  style = "text-align : center;">Welcome To Credit Edit Page</h1>
                        <form action ="CreditUpdate.php?id=<?= $row['Id'] ?>" method="POST">
<!-- <div class="mb-3">

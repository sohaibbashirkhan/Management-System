...
<body class="sb-nav-fixed">
    ...
    <select name="txttitle" class="form-control" required>
...
if(isset($_POST["submit"])){
    ...
    // Query
    $query="INSERT INTO `product`(`id`,`cate_id`,`title`, `color`, `pack`, `quantity`, `price`) VALUES (null,'$Cate','$Title','$Color','$Pack','$Quantity','$Price')";

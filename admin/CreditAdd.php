...
<html lang="en">
    <head>
        ...
        <title>Dashboard - Credit Add</title>
...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Add Credit</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Add Credit Dashboard</li>
            </ol>
...
<!-- php -->
  ...
  if(isset($_POST["submit"])){
    ...
    $Address =  mysqli_real_escape_string($conn,$_POST['txtaddress']);
                              ...
                              // Query
                             $query = "INSERT INTO `credit`(`name`, `phone`, `address`) VALUES ('$Name', '$Phone', '$Address')";

mysqli_query($conn,$query);
    ?>  
  <script>
      window.location.assign("Credit.php?add");
    </script>

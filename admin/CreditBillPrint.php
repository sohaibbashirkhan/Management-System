        ...
        class BillPrinter {
            ...
            public function printBill() {
                if(isset($_POST["submit"])) {
                    ...
                    $select = "SELECT creditorders.id, creditorders.Userid, creditproduct.title, creditorders.quantity, creditorders.date, creditorders.price FROM `creditorders` INNER JOIN `creditproduct` ON creditorders.product_id = creditproduct.id
                        WHERE creditorders.id = $customer AND date BETWEEN '$startdate' AND '$enddate'";

                    $count = "SELECT SUM(creditorders.price * creditorders.quantity) 
                                FROM `creditorders` 
                                WHERE creditorders.id = $customer AND date BETWEEN '$startdate' AND '$enddate'";
                    ...
                    if(mysqli_num_rows($result)) {
                        $user = "SELECT * FROM `creditorders` WHERE `id` = $customer";

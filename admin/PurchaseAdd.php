...
if(isset($_POST["submit"])){
    ...
    if(mysqli_num_rows($product_result) > 0) {
        ...
        // Insert order record
        $query = "INSERT INTO `purchase`(`id`, `Customer_name`, `cate_id`, `product_id`, `product_color`, `item`, `quantity`,`price`) VALUES (null,'$Customer','$category_id','$Product_id', '$Product_Color', '$Product_item','$Quantity','$Price')";
        ...
        ?>
        <script>
            window.location.assign("Purchase.php?add");
        </script>
        <?php
    } else {
        // Product not found
...
<html lang="en">
    <head>
        ...
        <title>Dashboard - Purchase Add</title>

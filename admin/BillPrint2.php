        ...
        class BillPrinter {
            ...
            public function printBill() {
                if(isset($_POST["submit"])) {
                    ...
                    $select = "SELECT orders.id, orders.Customer_name, product.title, orders.quantity, orders.date, orders.price  
                        FROM `orders` 
                        INNER JOIN `product` ON orders.product_id = product.id
                        WHERE orders.id = $customer AND date BETWEEN '$startdate' AND '$enddate'";

                    $count = "SELECT SUM(orders.price * orders.quantity) 
                                FROM `orders` 
                                WHERE orders.id = $customer AND date BETWEEN '$startdate' AND '$enddate'";

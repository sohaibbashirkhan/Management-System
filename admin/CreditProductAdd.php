...
<head>
    ...
    <title>Dashboard - credit Product Add</title>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Add credit Product</h1>
...
if(isset($_POST["submit"])){
    ...
    // Query
    $query="INSERT INTO `creditproduct`(`id`,`cate_id`,`title`, `color`, `pack`, `quantity`, `price`) VALUES (null,'$Cate','$Title','$Color','$Pack','$Quantity','$Price')";

    mysqli_query($conn,$query);
?>
    <script>
        window.location.assign("CreditProduct.php?add");
    </script>
<?php
}
?>

...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Add Home Product</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Add Home Product Dashboard</li>
            </ol>
...
<?php
  ...
  if(isset($_POST["submit"])){
    ...
    $Price = mysqli_real_escape_string($conn,$_POST['txtprice']);
                              ...
                              // Query
$query="INSERT INTO `homeproduct`(`id`, `title`, `price`) VALUES (null,'$Title','$Price')";

mysqli_query($conn,$query);
    ?>  
  <script>
      window.location.assign("HomeProduct.php?add");
    </script>

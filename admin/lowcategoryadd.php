...
class DailyExpenseAdd {
    ...
    public function addExpense() {
        if(isset($_POST["submit"])){
            ...
            $query = "INSERT INTO `lowcategory`(`cate_id`, `cate_name`) VALUES (null, '$Name')";
            mysqli_query($this->conn, $query);

            header("Location: lowcategory.php?add");
            exit();
        }
    }
    ...
    public function displayAddExpenseForm() {
        ...
        <head>
            ...
            <title>Dashboard - Categories Expense Add</title>
...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Add Categories Expense</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Add Categories Dashboard</li>
            </ol>

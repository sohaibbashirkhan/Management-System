...
if(isset($_POST["submit"])){
    ...
    if($available_quantity >= $Quantity) {
        // Insert order record
        $query = "INSERT INTO `orders`(`id`, `Customer_name`, `cate_id`, `product_id`, `product_color`, `item`, `quantity`, `price`) VALUES (null, '$Customer', '$category_id', '$Product_id', '$Product_Color', '$Product_item', '$Quantity', '$Price')";

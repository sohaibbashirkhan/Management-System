...
if(isset($_POST["submit"])){
    ...
    if(mysqli_num_rows($product_result) > 0) {
        ...
        // Insert order record
        $query = "INSERT INTO `lowitempurchase`(`id`, `Customer_name`, `cate_id`, `product_id`, `product_color`, `item`, `quantity`,`price`) VALUES (null,'$Customer','$category_id','$Product_id', '$Product_Color', '$Product_item','$Quantity','$Price')";
        ...
        ?>
        <script>
            window.location.assign("lowpurchase.php?add");
        </script>
        <?php
    } else {
        // Product not found
...
<html lang="en">
    <head>
        ...
        <title>Dashboard - Low Purchase Add</title>
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">Add Purchase Dashboard</li>
            </ol>

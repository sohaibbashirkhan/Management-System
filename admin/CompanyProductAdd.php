...
<head>
    ...
    <title>Dashboard - Company Product Add</title>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Add Company Product</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Add Product Dashboard</li>
                </ol>
                <!-- Add Product Form -->
...
if(isset($_POST["submit"])){
    ...
    // Query
    $query="INSERT INTO `companyproduct`(`id`,`cate_id`,`title`, `color`, `pack`, `quantity`, `price`) VALUES (null,'$Cate','$Title','$Color','$Pack','$Quantity','$Price')";

    mysqli_query($conn,$query);
?>
    <script>
        window.location.assign("CompanyProduct.php?add");
    </script>
<?php
}
?>

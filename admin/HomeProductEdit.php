...
include_once("DatabaseConn.php");
     $id = $_GET['id'];
     $row = mysqli_fetch_assoc(mysqli_query($conn,"select * from homeproduct where id =' $id'"));
  ?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Edit Home Product</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Edit Home Product Dashboard</li>
                </ol>

                        <form action ="HomeProductUpdate.php?id=<?= $row['id'] ?>" method="POST" >
<!-- <div class="mb-3">
